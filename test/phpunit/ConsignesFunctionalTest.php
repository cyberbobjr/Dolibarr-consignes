...
/**
 * \file    test/functional/ConsignesFunctionalTest.php
 * \ingroup consignes
 ...
 *
 * @package Testconsignes
 */
class ConsignesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modConsignes')->click();
		} else {
			// Disable the module
			$this->byHref('modConsignes')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/consignes/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('consignes/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/consignes/admin/about.php');
		$this->authenticate();
		return $this->assertContains('consignes/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('consigneswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modConsignes_ConsignesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modConsignes_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
