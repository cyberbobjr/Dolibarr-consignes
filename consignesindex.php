...
/**
 *    \file       htdocs/consignes/template/consignesindex.php
 *    \ingroup    consignes
 *    \brief      Home page of consignes top menu
 */
...
llxHeader("", $langs->trans("ConsignesArea"));

print load_fiche_titre($langs->trans("ConsignesArea"), '', 'consignes.png@consignes');
...
// Draft MyObject
if (! empty($conf->consignes->enabled) && $user->rights->consignes->read)
{
	$langs->load("orders");
